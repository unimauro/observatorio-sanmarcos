#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Consulta Amigable MEF -> serie histórica pliego 510 (U.N. MAYOR DE SAN MARCOS).
Drill: Año -> Nivel de Gobierno -> E: GOBIERNO NACIONAL -> Sector 10 EDUCACION -> Pliego 510.
Parsea PIA/PIM/Certificado/Comprometido/Devengado/Girado de la fila 510.
Guarda raw en ca_sanmarcos_raw.json. El merge lo hace merge_presupuesto.py.
Adaptado de observatorio-uni/etl/scraper_ca_uni.py (pliego 514).
"""
...
def main():
    ...
    json.dump({str(y): r for y, r in results.items()},
              open(os.path.join(HERE, "ca_sanmarcos_raw.json"), "w"), ensure_ascii=False)
