...
function renderInv() {
  ...
  document.getElementById('invNote').textContent = `San Marcos: ${fmtN(b.works)} publicaciones, ${fmtN(b.cited)} citas, h-index ${b.h_index} (OpenAlex, ${DATA.biblio._meta?.extraido || '2026'}). La universidad más productiva del Perú en volumen.`;
}
